...
pingtest 240.1.2.1 240.1.2.4 24  || echo fail >&2
pingtest 250.1.2.1 250.1.2.4 24  || echo fail >&2

# Test support for 0/8
pingtest 0.1.2.17 0.1.2.23 24  || echo fail >&2

# Test support for zeroth host
# pingtest 5.10.15.20 5.10.15.0 24  || echo fail >&2
